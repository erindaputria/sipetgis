...
$(document).ready(function() {
    ...
    $('#formDemplot').submit(function(e) {
        e.preventDefault();
        let isValid = true;
        const fields = ['nama_demplot', 'nama_petugas', 'kecamatan', 'kelurahan', 'alamat', 'luas_m2', 'jenis_hewan', 'jumlah_hewan', 'stok_pakan', 'latitude', 'longitude'];
...
function printWithCurrentData() {
    ...
    printWindow.document.write('<html><head><title>Data Demplot</title>');
