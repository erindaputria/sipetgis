...
function printWithCurrentData() {
    ...
    printWindow.document.write('.nama-toko { font-weight: 600; }');
    ...
    // ========== 2. TABEL DETAIL PENJUAL OBAT HEWAN ==========
    printWindow.document.write('<h3 style="margin-top: 20px; color: #832706;">A. DATA PENJUAL OBAT HEWAN</h3>');
    ...
    if ($('#rekapKecamatanTable').length > 0) {
        ...
        printWindow.document.write('<h3 style="color: #832706;">B. REKAP PENJUAL OBAT HEWAN PER KECAMATAN</h3>');
        printWindow.document.write('</div>');
...
function updateRekapTable(data, totals) {
    ...
    for(var i = 0; i < data.length; i++) {
        var item = data[i];
        var jumlah = parseInt(item.jumlah_toko) || 0;
        totalToko += jumlah;
