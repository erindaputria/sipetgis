...
<html lang="en">
  ...
  <body>
              ...
              <li class="nav-item active">
                ...
                <div class="collapse" id="dataSubmenu">
                  <ul class="list-unstyled ps-4">
                    ...
                    <li>
                      <a href="data-pengobatan.html" class="nav-link active"
                        >Pengobatan Ternak</a
                      >
                    </li>
                  </ul>
          ...
          <div class="page-inner">
            ...
            >
              <div>
                ...
                <h6 class="op-7 mb-0">
                  Manajemen history data pengobatan di Kota Surabaya
                </h6>
              </div>
            </div>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table id="historyDataTable" class="table table-hover">
                    ...
                    <tbody>
                      <!-- Data dari gambar yang diberikan untuk History Pengobatan -->
                      <tr>
                        <td>1</td>
                        <td>BULUH MERINDU (Kelompok Ternak)</td>
                        <td>Kambing</td>
                        <td>Pengobatan Herbal</td>
                        <td>
                          <span class="">21</span> <span class="">Ekor</span>
                        </td>
                        <td>
                          <div>
                      ...
                      <tr>
                        <td>3</td>
                        <td>GARDA PEMUDA (Kelompok Ternak)</td>
                        <td>Sapi Potong</td>
                        <td>Pengobatan Herbal</td>
                        <td>
                          <span class="">32</span> <span class="">Ekor</span>
                        </td>
                        <td>
                          <div>
                      ...
                      <tr>
                        <td>4</td>
                        <td>Ternak Sejahtera (Kelompok Ternak)</td>
                        <td>Ayam Kampung</td>
                        <td>Pengobatan Antibiotik</td>
                        <td>
                      ...
                      <tr>
                        <td>5</td>
                        <td>Peternak Mandiri (Kelompok Ternak)</td>
                        <td>Itik</td>
                        <td>Pengobatan Vitamin</td>
                        <td>
                          <span class="">35</span> <span class="">Ekor</span>
                        </td>
                        <td>
                          <div>
                      ...
                      <tr>
                        ...
                        <td>Sapi Potong</td>
                        <td>Pengobatan Anti Parasit</td>
                        <td>
                          <span class="">15</span> <span class="">Ekor</span>
                        </td>
                        <td>
                          <div>
                            <div class="mb-1">-7.2630, 112.7580</div>
                            <button
                              class="btn btn-sm btn-outline-primary"
                              onclick="
                                showMap(
            ...
            >
              <div class="detail-header">
                <h5 class="fw-bold mb-0" id="detailTitle">
                  Detail History Data Pengobatan
                </h5>
    ...
    <script>
      // Data untuk detail history (update untuk pengobatan)
      ...
      // Data untuk informasi lokasi terdekat (sesuai gambar)
      const locationInfoData = [
        "Kecamatan: Kedai beauty",
        "Kota: Lapangan Deraah",
        "Kabupaten: Diins Satpoi PP",
        "Provinsi: Diins Satpoi PP",
        "Telp: 0123456789",
      ...
      // Parameter ditambah untuk menangani jenis pengobatan
      function showMap(jenisPengobatan, peternak, komoditas, coordinates) {
        // Parse coordinates
        ...
        $("#mapTitle").text(
          `Peta Lokasi Pengobatan Ternak ${komoditas}, Peternak: ${peternak}, Jenis Pengobatan: ${jenisPengobatan} adalah sebagai berikut:`,
        );
        $("#mapInfo").html(`
          <div class="row">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <span class="fw-bold">Jenis Pengobatan:</span> ${jenisPengobatan}
            </div>
          </div>
        `);

        // Update farm info untuk pengobatan
        $("#farmInfo").html(`
          <div class="mb-2">
          ...
          <div class="mb-2">
            <span class="fw-bold">Jenis Pengobatan:</span><br>
            <span class="badge bg-warning text-dark">${jenisPengobatan}</span>
          </div>
          <div class="mb-2">
            <span class="fw-bold">Jumlah Ternak:</span><br>
            <span class="fw-bold">20 Ekor</span>
          </div>
          <div class="mb-2">
            <span class="fw-bold">Status:</span><br>
            <span class="badge bg-info">Sedang Diobati</span>
          </div>
        `);
        ...
        if (!map) {
          ...
          setTimeout(() => {
            ...
            // Buat custom icon untuk pengobatan (warna oranye untuk pengobatan)
            const farmIcon = L.divIcon({
              html: `<div style="background-color: #ff9800; width: 24px; height: 24px; border-radius: 50%; border: 3px solid white; box-shadow: 0 0 10px rgba(0,0,0,0.5); display: flex; align-items: center; justify-content: center; font-weight: bold; color: white; font-size: 14px;">O</div>`,
              className: "farm-marker",
              iconSize: [30, 30],
              iconAnchor: [15, 15],
            });

            // Add marker untuk lokasi pengobatan
            ...
            currentFarmMarker
              ...
              <div style="min-width: 200px;">
                <h5 style="margin: 0 0 5px 0; color: #ff9800; text-align: center;">${peternak}</h5>
                <hr style="margin: 5px 0;">
                <div style="margin-bottom: 3px;"><strong>Komoditas:</strong> ${komoditas}</div>
                <div style="margin-bottom: 3px;"><strong>Jenis Pengobatan:</strong> ${jenisPengobatan}</div>
                <div style="margin-bottom: 3px;"><strong>Koordinat:</strong> ${lat.toFixed(6)}, ${lng.toFixed(6)}</div>
                <div style="margin-bottom: 3px;"><strong>Jumlah Ternak:</strong> 20 Ekor</div>
