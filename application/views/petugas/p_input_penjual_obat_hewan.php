...
<head>
    ...
    <title>Input Penjual Obat Hewan - SIPETGIS</title>
...
<body>
                ...
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div class="flex-grow-1">
                            <h3 class="fw-bold mb-1">Penjual Obat Hewan</h3>
                    ...
                    <div id="alert-container"></div>
                     ...
                     <!-- Action Card + Input Penjual Obat Hewan -->
                    <div class="row mt-4">
                        <div class="col-md-12">
                            ...
                            <div class="card action-card">
                                <div class="card-body text-center p-4">
                                    <button type="button" class="btn btn-toggle-form" id="toggleFormBtn">
                                        <i class="fas fa-plus-circle me-2"></i> INPUT PENJUAL OBAT HEWAN
                                    </button>
                                </div>
                            </div>
                            ...
                            <div class="form-container" id="formContainer">
                                <div class="card form-card">
                                    <div class="card-header">
                                        <h4 class="card-title">INPUT DATA PENJUAL OBAT HEWAN BARU</h4>
                                    </div>
                                    <div class="card-body">
                                        <form id="formPenjualObat" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="invalid-feedback">Kategori obat harus dipilih</div>
                                                </div>
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <div class="invalid-feedback">Jenis obat harus dipilih</div>
                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-12 mb-3">
                                                                    <div class="d-flex align-items-start">
                                                                        <div class="me-3">
                                                                            <div class="photo-placeholder" id="photoPlaceholder" onclick="document.getElementById('foto_penjual_obat').click()">
                                                                        ...
                                                                        <div class="flex-grow-1">
                                                                            <input type="file" class="form-control d-none" id="foto_penjual_obat" name="foto_penjual_obat" accept="image/jpeg, image/jpg, image/png" />
                                                                            <small class="text-muted d-block mb-2">Upload foto toko (maks. 5MB, format: JPG, PNG)</small>
                                                                            <button type="button" class="btn btn-outline-secondary btn-sm" onclick="document.getElementById('foto_penjual_obat').click()">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-3">
                                <div class="form-group mb-0">
                                    ...
                                    <select class="form-select" id="filterKategoriObat">
                    ...
                    <div class="card form-card mt-4">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="penjualObatTable" class="table table-bordered table-hover table-custom">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Nama Toko</th>
                                    ...
                                    <tbody id="dataTableBody">
                                        <?php if (!empty($penjual_obat_data)): ?>
                                            <?php $no = 1; ?>
                                            <?php foreach ($penjual_obat_data as $data): ?>
                                                <tr>
                                                    <td><?php echo $no++; ?></td>
                                                    <td><?php echo htmlspecialchars($data['nama_toko'] ?? '-'); ?></td>
                                                    <td><?php echo htmlspecialchars($data['nama_pemilik'] ?? '-'); ?></td>
                                                    <td><?php echo htmlspecialchars($data['kategori_obat'] ?? '-'); ?></td>
                                                    ...
                                                    <td>
                                                        <?php if (!empty($data['foto_penjual_obat'])): ?>
                                                            <a href="javascript:void(0)" class="foto-link" onclick="showFoto('<?php echo base_url(); ?>uploads/penjual_obat/<?php echo $data['foto_penjual_obat']; ?>')">
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Foto Penjual Obat Hewan</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body text-center">
                                    <img id="fotoModalImg" src="" alt="Foto Penjual Obat" style="max-width: 100%; max-height: 80vh;">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let dataTable = $('#penjualObatTable').DataTable({
                language: {
                    search: "Cari:",
            ...
            $('#toggleFormBtn').click(function() {
                ...
                if (formContainer.hasClass('show')) {
                    $(this).html('<i class="fas fa-minus-circle me-2"></i> TUTUP FORM INPUT PENJUAL OBAT HEWAN');
                    $('html, body').animate({
                        scrollTop: formContainer.offset().top - 50
                    }, 500);
                } else {
                    $(this).html('<i class="fas fa-plus-circle me-2"></i> INPUT PENJUAL OBAT HEWAN');
                }
            });
            ...
            function resetForm() {
                ...
                $('#toggleFormBtn').html('<i class="fas fa-plus-circle me-2"></i> INPUT PENJUAL OBAT HEWAN');
                
                // Reset field
                $('#formPenjualObat')[0].reset();
            ...
            $('#foto_penjual_obat').change(function(e) {
            ...
            function filterData() {
                ...
                const kategoriObat = $("#filterKategoriObat").val();
            ...
            $('#formPenjualObat').submit(function(e) {
                e.preventDefault();
                ...
                $.ajax({
                    url: '<?php echo base_url("P_Input_Penjual_Obat_Hewan/save"); ?>',
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
