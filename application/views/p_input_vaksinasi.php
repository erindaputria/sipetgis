                                    ...
                                    <div class="card-body">
                                        <form id="formVaksinasi" enctype="multipart/form-data">
                                            ...
                                            <div class="row">
                                                ...
                                                <!-- Jenis Vaksinasi -->
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label required-field">Jenis Vaksinasi</label>
                                                    <select class="form-control" id="jenis_vaksinasi" name="jenis_vaksinasi" required>
                                                        <option value="">Pilih Jenis Vaksinasi</option>
                                                    ...
                                                    <div class="invalid-feedback">Jenis vaksinasi harus dipilih</div>
                                                </div>

                                                <!-- Jumlah -->
                                                <div class="col-md-6 mb-3">
                                                    <label class="form-label required-field">Jumlah</label>
                                                    <input type="number" class="form-control" id="jumlah" name="jumlah" placeholder="Masukkan jumlah vaksinasi" min="1" required />
