  ...
  <body>
        ...
        <div class="container">
          <div class="page-inner">
                  ...
                  <form action="<?= base_url('komoditas/simpan'); ?>" method="post">
                    <div class="modal-header">
                      <h5 class="modal-title">
                        <i class="fas fa-seedling me-2"></i>Tambah Data Komoditas
                      </h5>
            ...
            <div class="modal fade" id="editDataModal" tabindex="-1">
              <div class="modal-dialog">
                <div class="modal-content">
                  <form action="<?= base_url('komoditas/update'); ?>" method="post">
                    <input type="hidden" name="id_komoditas" id="edit_id">
                    <div class="modal-header">
                      <h5 class="modal-title">
                        <i class="fas fa-edit me-2"></i>Edit Data Komoditas
                      </h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="table-responsive">
                      <table id="komoditasTable" class="table table-hover w-100">
                        ...
                        <tbody>
                              ...
                              <tr>
                                ...
                                <td>
                                  <span class="badge-kelompok 
                                    <?php 
                                      $jenis = strtolower($row->jenis_hewan ?? '');
                                      if(strpos($jenis, 'sapi') !== false) echo 'badge-sapi';
                                      elseif(strpos($jenis, 'kambing') !== false) echo 'badge-kambing';
                                      elseif(strpos($jenis, 'domba') !== false) echo 'badge-domba';
                                      elseif(strpos($jenis, 'unggas') !== false) echo 'badge-unggas';
                                      else echo 'badge-lainnya';
                                    ?>">
                                    <?= htmlspecialchars($row->jenis_hewan ?? ''); ?>
                                  </span>
                                </td>
                                <td>
                                  <span class="badge-satuan"><?= htmlspecialchars($row->satuan ?? ''); ?></span>
                                </td>
                                <td>
                                  <span class="badge-jk 
                                    <?php 
                                      $jk = $row->jenis_kelamin ?? '';
                                      if($jk == 'P') echo 'badge-p';
                                      elseif($jk == 'L') echo 'badge-l';
                                      else echo 'badge-keduanya';
                                    ?>">
                                    <?php 
                          ...
                          <?php else: ?>
                            <tr>
                              <td colspan="6" class="text-center">Tidak ada data komoditas</td>
                            </tr>
                          <?php endif; ?>
                        </tbody>
                      </table>
    ...
    <script>
      $(document).ready(function() {
        // Inisialisasi DataTable DENGAN tombol Excel, PDF, Print
        var table = $('#komoditasTable').DataTable({
          ...
          buttons: [
            {
              ...
              exportOptions: {
                columns: [0, 1, 2, 3, 4] // Export kolom 0-4 (No, Nama, Jenis, Satuan, JK)
              }
            },
            {
              extend: "pdf",
          ...
          responsive: true,
          columnDefs: [
            { orderable: false, targets: [0, 5] } // Non-aktifkan sorting untuk kolom No dan Aksi
          ]
        });
