...
<head>
    ...
    <!-- Custom CSS Laporan Demplot Peternakan -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/laporan_demplot_peternakan.css'); ?>" />
</head>
...
<body>
                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse" id="laporanSubmenu"> 
                                <ul class="list-unstyled ps-4">
                                    ...
                                    <li><a href="<?= site_url('laporan_demplot_peternakan') ?>" class="nav-link active">Demplot Peternakan</a></li>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Laporan Demplot Peternakan</h3>
    ...
    <!-- Custom JS Laporan Demplot Peternakan -->
    <script src="<?php echo base_url('assets/js/laporan_demplot_peternakan.js'); ?>"></script>
</body>
</html>