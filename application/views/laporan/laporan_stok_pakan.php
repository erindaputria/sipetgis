...
<head>
    ...
    <!-- Custom CSS Laporan Stok Pakan -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/laporan_stok_pakan.css'); ?>" />
</head>
...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Laporan Stok Pakan</h3>
    ...
    <!-- Custom JS Laporan Stok Pakan -->
    <script src="<?php echo base_url('assets/js/laporan_stok_pakan.js'); ?>"></script>
</body>
</html>