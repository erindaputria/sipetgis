...
<head>
    ...
    <!-- Custom CSS Laporan History Data Ternak -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/laporan_history_data_ternak.css'); ?>" />
</head>
...
<body>
                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse" id="laporanSubmenu"> 
                                <ul class="list-unstyled ps-4">
                                    ...
                                    <li><a href="<?= site_url('laporan_history_data_ternak') ?>" class="nav-link active">History Data Ternak</a></li>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Laporan History Data Ternak</h3>
    ...
    <!-- Custom JS Laporan History Data Ternak -->
    <script src="<?php echo base_url('assets/js/laporan_history_data_ternak.js'); ?>"></script>
</body>
</html>