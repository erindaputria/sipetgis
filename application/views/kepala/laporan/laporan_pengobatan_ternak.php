...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Laporan Pengobatan Ternak</h3>
    ...
    <!-- Custom JS Laporan Pengobatan Ternak -->
    <script src="<?php echo base_url('assets/js/laporan_pengobatan_ternak.js'); ?>"></script>
</body>
</html>