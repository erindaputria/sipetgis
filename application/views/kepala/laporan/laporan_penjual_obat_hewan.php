...
<head>
    ...
    <!-- Custom CSS Laporan Penjual Obat Hewan -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/laporan_penjual_obat_hewan.css'); ?>" />
...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Laporan Penjual Obat Hewan</h3>
                    ...
                    <!-- Main Table (Detail Penjual Obat) -->
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="obatHewanTable" class="table table-hover w-100">
                                            <thead>
                                                <tr>
                                                    <th width="50">No</th>
                                                    <th>Nama Toko</th>
                    ...
                    <!-- NEW CARD: REKAP PENJUAL OBAT PER KECAMATAN (0-0-0) -->
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" style="background-color: #ffffff; border-bottom: 1px solid #e2e8f0;">
                                    <div class="card-title fw-bold" style="color: #000000 !important;">
                                        <i class="fas fa-chart-pie me-2" style="color: #000000 !important;"></i>REKAP PENJUAL OBAT PER KECAMATAN
                                    </div>
                                    <div class="card-subtitle text-muted">
                                        Klik angka untuk melihat detail toko penjual obat per kecamatan
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
    ...
    <!-- Custom JS Laporan Penjual Obat Hewan -->
    <script src="<?php echo base_url('assets/js/laporan_penjual_obat_hewan.js'); ?>"></script>
</body>
</html>