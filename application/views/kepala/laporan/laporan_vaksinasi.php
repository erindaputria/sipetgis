...
<head>
    ...
    <!-- Custom CSS Laporan Vaksinasi -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/laporan_vaksinasi.css'); ?>" />
</head>
...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Laporan Vaksinasi Ternak</h3>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="vaksinasiTable" class="table table-hover w-100">
    ...
    <!-- Custom JS Laporan Vaksinasi -->
    <script src="<?php echo base_url('assets/js/laporan_vaksinasi.js'); ?>"></script>
</body>
</html>