...
<head>
    ...
    <!-- Custom CSS Laporan Data TPU/RPU -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/laporan_data_tpu_rpu.css'); ?>" />
...
<body>
                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse" id="laporanSubmenu"> 
                                <ul class="list-unstyled ps-4">
                                    ...
                                    <li><a href="<?= site_url('k_laporan_kepala/data_tpu_rpu') ?>" class="nav-link active">Data TPU / RPU</a></li>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Laporan Data TPU/RPU</h3>
                            <h6 class="op-7 mb-0">Data Tempat Pemotongan Unggas Kota Surabaya</h6>
                        </div>
                    ...
                    <div class="report-header" id="reportHeader">
                        <div class="report-title" id="reportTitle">
                            DATA TEMPAT PEMOTONGAN UNGGAS KOTA SURABAYA
                        </div>
                    ...
                    <!-- Main Table (Detail TPU/RPU) -->
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="tpuRpuTable" class="table table-hover w-100">
                                            <thead>
                                                <tr>
                                                    <th width="50">No</th>
                                                    <th>Nama TPU/RPU</th>
                    ...
                    <!-- NEW CARD: REKAP TPU/RPU PER KECAMATAN (0-0-0) -->
                    <div class="row mt-4">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header" style="background-color: #ffffff; border-bottom: 1px solid #e2e8f0;">
                                    <div class="card-title fw-bold" style="color: #000000 !important;">
                                        <i class="fas fa-chart-pie me-2" style="color: #000000 !important;"></i>REKAP TPU/RPU PER KECAMATAN
                                    </div>
                                    <div class="card-subtitle text-muted">
                                        Klik angka untuk melihat detail TPU/RPU per kecamatan
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="rekapKecamatanTable" class="table table-bordered table-hover w-100">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">Jumlah TPU/RPU</th>
                                                </tr>
                                            </thead>
    ...
    <!-- Custom JS Laporan Data TPU/RPU -->
    <script src="<?php echo base_url('assets/js/laporan_data_tpu_rpu.js'); ?>"></script>
</body>
</html>