...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Laporan Data Klinik Hewan</h3>
    ...
    <!-- Custom JS Laporan Data Klinik Hewan -->
    <script src="<?php echo base_url('assets/js/laporan_data_klinik_hewan.js'); ?>"></script>
</body>
</html>