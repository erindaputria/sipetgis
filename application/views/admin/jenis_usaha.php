...
<head>
    ...
    <title>Master Jenis Usaha - SIPETGIS</title>
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
            <div class="sidebar-content">
                <ul class="nav nav-secondary">
                    ...
                    <li class="nav-item">
                        <a class="nav-link d-flex align-items-center justify-content-between" data-bs-toggle="collapse" href="#masterDataSubmenu">
        ...
        <div class="container">
            <div class="page-inner">
                ...
                <div class="modal fade" id="tambahDataModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content modal-form">
                            <form action="<?= base_url('jenis_usaha/simpan'); ?>" method="post" id="formTambah">
                                <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />
                                <div class="modal-header">
                                    <h5 class="modal-title"><i class="fas fa-plus-circle me-2"></i>Tambah Jenis Usaha</h5>
                                ...
                                <div class="modal-body">
                                    <div class="form-group">
                                        ...
                                        <small class="text-muted">Contoh: Peternak Sapi Perah, Penjual Pakan Ternak, dll.</small>
                                    </div>
                                </div>
                ...
                <div class="modal fade" id="editDataModal" tabindex="-1">
                    <div class="modal-dialog">
                        <div class="modal-content modal-form">
                            <form action="<?= base_url('jenis_usaha/update'); ?>" method="post" id="formEdit">
                                <input type="hidden" name="<?= $this->security->get_csrf_token_name(); ?>" value="<?= $this->security->get_csrf_hash(); ?>" />
                                <input type="hidden" id="edit_id" name="id">
                                <div class="modal-header">
                                    <h5 class="modal-title"><i class="fas fa-edit me-2"></i>Edit Jenis Usaha</h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="form-group">
                                    ...
                                    <table id="jenisUsahaTable" class="table table-hover w-100">
                                        ...
                                        <tbody>
                                            <?php if(!empty($jenis_usaha)): ?>
                                                ...
                                                <?php endforeach; ?>
                                            <?php else: ?>
                                                <tr><td colspan="3" class="text-center">Tidak ada data</td><td style="display:none"></td></tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
                                </div>
...
<!-- DataTables JS - Gunakan versi yang sama dengan CSS -->
