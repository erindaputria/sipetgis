...
<head>
    ...
    <title>Master Data Komoditas - SIPETGIS</title>
    ...
    <!-- Custom CSS Komoditas -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/komoditas.css'); ?>" />
</head>
...
<body>
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="masterDataSubmenu">
                                <ul class="list-unstyled ps-4">
                                    ...
                                    <li><a href="<?= site_url('komoditas') ?>" class="nav-link active">Komoditas</a></li>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Master Komoditas</h3>
                            <h6 class="op-7 mb-0">Kelola Data Komoditas</h6>
                        </div>
                    ...
                    <div class="modal fade" id="tambahDataModal" tabindex="-1">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content modal-form">
                                <form action="<?= base_url('komoditas/simpan'); ?>" method="post" id="formTambah">
                                    <div class="modal-header">
                                        <h5 class="modal-title"><i class="fas fa-seedling me-2"></i>Tambah Data Komoditas</h5>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <div class="form-group">
                                                    <label>Nama Komoditas <span class="text-danger">*</span></label>
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="jenis" class="form-control" required>
                                                        ...
                                                        <option value="Hewan Besar">Hewan Besar</option>
                    ...
                    <div class="modal fade" id="editDataModal" tabindex="-1">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content modal-form">
                                <form action="<?= base_url('komoditas/update'); ?>" method="post" id="formEdit">
                                    <input type="hidden" id="edit_id" name="id_komoditas">
                                    <div class="modal-header">
                                        <h5 class="modal-title"><i class="fas fa-edit me-2"></i>Edit Data Komoditas</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <div class="form-group">
                                                    <label>Nama Komoditas <span class="text-danger">*</span></label>
                                                    <input type="text" id="edit_nama" name="nama_komoditas" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="komoditasTable" class="table table-hover w-100">
                                            <thead>
                                                <tr>
                                                    <th width="50">No</th>
                                                ...
                                                <?php if(!empty($komoditas)): ?>
                                                    ...
                                                    <?php foreach($komoditas as $row): ?>
                                                        <tr>
                                                            ...
                                                            <td><?= htmlspecialchars($row->jenis_hewan ?? ''); ?> <!-- LANGSUNG TEKS, TANPA BADGE -->
                                                            <td><?= htmlspecialchars($row->satuan ?? ''); ?> <!-- LANGSUNG TEKS, TANPA BADGE -->
                                                            <td>
                                                                <?php 
                                                                    if(($row->jenis_kelamin ?? '') == 'P') echo 'Perempuan';
                                                                    elseif(($row->jenis_kelamin ?? '') == 'L') echo 'Laki-laki';
                                                                    else echo 'Keduanya';
                                                                ?>
                                                             </td>
                                                            <td>
                                                                <button class="btn btn-action btn-edit" title="Edit"
                                                                        data-id="<?= $row->id_komoditas ?? ''; ?>"
                                                                        data-nama="<?= htmlspecialchars($row->nama_komoditas ?? ''); ?>"
                                                                        data-jenis="<?= htmlspecialchars($row->jenis_hewan ?? ''); ?>"
    ...
    <!-- Custom JS Komoditas -->
    <script src="<?php echo base_url('assets/js/komoditas.js'); ?>"></script>
</body>
</html>