...
<body>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">History Data Pengobatan</h3>
            ...
            <div class="modal-content">
                <form id="formEdit">
                    ...
                    <div class="modal-header bg-primary-custom text-white">
                        <h5 class="modal-title"><i class="fas fa-edit me-2"></i>Edit Data Pengobatan</h5>
                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                    </div>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tanggal Pengobatan <span class="text-danger">*</span></label>
                                <input type="date" class="form-control" id="edit_tanggal" name="tanggal_pengobatan" required>
                            </div>
                            <div class="col-md-6 mb-3">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Gejala Klinis <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="edit_gejala" name="gejala_klinis" rows="2" required></textarea>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label class="form-label">Tindakan Pengobatan <span class="text-danger">*</span></label>
                                <textarea class="form-control" id="edit_tindakan" name="jenis_pengobatan" rows="2" required></textarea>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
    ...
    <div class="modal fade modal-foto" id="fotoModal" tabindex="-1">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header bg-primary-custom text-white"><h5 class="modal-title">Foto Pengobatan</h5><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button></div>
                <div class="modal-body"><img id="fotoModalImg" src="" alt="Foto Pengobatan" style="max-width:100%; max-height:80vh;"></div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger-custom text-white"><h5 class="modal-title">Konfirmasi Hapus</h5><button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button></div>
    ...
    <!-- Custom JS Data Pengobatan -->
    <script src="<?php echo base_url('assets/js/data_pengobatan.js'); ?>"></script>
</body>
</html>