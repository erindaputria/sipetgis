                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse" id="dataSubmenu">
                                <ul class="list-unstyled ps-4">
                                    ...
                                    <li><a href="<?php echo base_url(); ?>data_history_ternak" class="nav-link active">History Data Ternak</a></li>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">History Data Ternak</h3>
                            <h6 class="op-7 mb-0">Manajemen history data ternak di Kota Surabaya</h6>
                        </div>
                    </div>
