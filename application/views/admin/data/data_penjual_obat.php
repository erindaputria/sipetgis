...
<head>
    ...
    <!-- Custom CSS Data Penjual Obat -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/data_penjual_obat.css'); ?>" />
</head>
                        ...
                        <li class="nav-item active">
                            ...
                            <div class="collapse" id="dataSubmenu">
                                <ul class="list-unstyled ps-4">
                                    ...
                                    <li><a href="<?= site_url('data_penjual_obat') ?>" class="nav-link active">Penjual Obat Hewan</a></li>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Data Penjual Obat Hewan</h3>
                            <h6 class="op-7 mb-0">Manajemen data penjual obat hewan di Kota Surabaya</h6>
                        </div>
                    </div>
                    ...
                    <div class="card stat-card">
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="penjualObatTable" class="table table-hover w-100">
                                    <thead>
                                        <tr>
                                            <th width="40">No</th>
                                            <th>Nama Toko</th>
                    ...
                    <div id="mapSection" class="map-section" style="display: none;">
                        <div class="detail-header">
                            <div class="map-title" id="mapTitle">Peta Lokasi Penjual Obat Hewan</div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-3" id="shopInfo"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card">
            ...
            <div class="modal-content">
                <form id="formEdit">
                    ...
                    <div class="modal-header bg-primary-custom text-white">
                        <h5 class="modal-title"><i class="fas fa-edit me-2"></i>Edit Data Penjual Obat</h5>
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Apakah Anda yakin ingin menghapus data penjual obat ini?</p>
