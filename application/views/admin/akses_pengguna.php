...
<head>
    ...
    <!-- CSRF Token untuk AJAX - TAMBAHAN INI AGAR HAPUS BERFUNGSI -->
...
<body>
    ...
    <!-- Custom JS Akses Pengguna - MODIFIKASI AGAR HAPUS BERFUNGSI -->
    <script>
    /**
    ...
    function togglePassword(inputId) {
        ...
        var button = null;
        if (inputId === 'password' || inputId === 'confirm_password' || inputId === 'edit_password') {
            button = input.parentElement.querySelector('.password-toggle');
        } else if (inputId === 'view_password') {
            button = input.parentElement.querySelector('.btn-outline-primary');
        }
