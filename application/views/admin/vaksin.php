...
<head>
    ...
    <!-- Custom CSS Vaksin -->
    <link rel="stylesheet" href="<?php echo base_url('assets/css/vaksin.css'); ?>" />
</head>
            ...
            <div class="container">
                <div class="page-inner">
                    ...
                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row pt-2 pb-4">
                        <div>
                            <h3 class="fw-bold mb-1" style="color: #832706; font-weight: 900;">Master Vaksin</h3>
                    ...
                    <div class="modal fade" id="tambahDataModal" tabindex="-1">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content modal-form">
                                <form action="<?= base_url('vaksin/simpan'); ?>" method="post" id="formTambah">
                                    <div class="modal-header">
                                        <h5 class="modal-title"><i class="fas fa-syringe me-2"></i>Tambah Data Vaksin</h5>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    <label>Status Perolehan <span class="text-danger">*</span></label>
                    ...
                    <div class="modal fade" id="editDataModal" tabindex="-1">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content modal-form">
                                <form action="<?= base_url('vaksin/update'); ?>" method="post" id="formEdit">
                                    <input type="hidden" id="edit_id" name="id_vaksin">
                                    <div class="modal-header">
                                        <h5 class="modal-title"><i class="fas fa-edit me-2"></i>Edit Data Vaksin</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                    </div>
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-12 mb-3">
                                                <div class="form-group">
                                                    <label>Jenis Vaksin <span class="text-danger">*</span></label>
                                                    <input type="text" id="edit_jenis" name="jenis_vaksin" class="form-control" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                <div class="form-group">
                                                    <label>Status Perolehan <span class="text-danger">*</span></label>
                                                    <select id="edit_status" name="status_perolehan" class="form-control" required>
                                                        <option value="">Pilih Status Perolehan</option>
                                                        <option value="Hibah/CSR">Hibah/CSR</option>
                                                        <option value="Pengadaan">Pengadaan</option>
                                                    </select>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="vaksinTable" class="table table-hover w-100">
                                            <thead>
                                                <tr>
                                                    <th width="50">No</th>
                                                    <th>Jenis Vaksin</th>
