...
class Obat extends CI_Controller {
    ...
    // ==================== HAPUS AJAX (SAMA PERSIS DENGAN VAKSIN) ====================
    public function hapus_ajax() {
        ...
        if ($result) {
            echo json_encode(['status' => 'success', 'message' => 'Data obat berhasil dihapus']);
        } else {
            echo json_encode(['status' => 'error', 'message' => 'Gagal menghapus data obat']);
        }
    }

    // ==================== EXPORT EXCEL (SAMA PERSIS DENGAN VAKSIN) ====================
    public function export_excel()
    {
        ...
        foreach($results as $item) {
            ...
            echo '<td align="left">' . (!empty($item->obat) ? $item->obat : '-') . '</td>';
            echo '<td align="left">' . (!empty($item->jenis_pengobatan) ? $item->jenis_pengobatan : '-') . '</td>';
            echo '<td align="left">' . (!empty($item->dosis) ? $item->dosis : '-') . '</td>';
            echo '</tr>';
        }
